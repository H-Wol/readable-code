...
public class MinesweeperGame {
    ...
    private static void actOnCell(String cellInput, String userActionInput) {
        ...
        if (doseUserChooseOpenCell(userActionInput)) {
    ...
    private static boolean doseUserChooseOpenCell(String userActionInput) {
    ...
    private static boolean isAllCellChecked() {
        return Arrays.stream(BOARD).flatMap(Arrays::stream).allMatch(cell -> cell.isChecked());
    }

    private static int convertRowFrom(char cellInputRow) {
        return getSelectedRowIndex(cellInputRow);

    }

    private static int getSelectedRowIndex(char cellInputRow) {
